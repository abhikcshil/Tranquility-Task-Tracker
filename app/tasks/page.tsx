                ...
                <div className="mb-2 flex items-center justify-between gap-2">
                  ...
                  <div className="flex gap-2">
                    <form action={toggleTaskCompletionAction}>
                      ...
                      <button type="submit" className="rounded-md border border-zinc-700 px-2 py-1 text-xs text-zinc-200">
                        Complete
                      </button>
                    </form>
                    <form action={archiveTaskAction}>
                      <input type="hidden" name="taskId" value={task.id} />
                      <button type="submit" className="rounded-md border border-zinc-700 px-2 py-1 text-xs text-zinc-400">
                        Archive
                      </button>
                    </form>
                  </div>
